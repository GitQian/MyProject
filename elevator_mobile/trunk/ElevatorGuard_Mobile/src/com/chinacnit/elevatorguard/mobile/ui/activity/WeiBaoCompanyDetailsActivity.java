 ...
 */
public class WeiBaoCompanyDetailsActivity extends BaseActivity implements
		OnClickListener {
	...
	private void initView() {
		...
		back_textview.setText(R.string.weibao_company_details);
	...
	private void setData() {
		if (mLoginDetail != null && companyId != 0) {
			new CompanyDetailTask(this, companyId, 1, R.string.loading, new IResultListener<CompanyDetail>() {
				...
				public void onError(String errMsg) {
					CommonToast.showToast(WeiBaoCompanyDetailsActivity.this, R.string.network_unavailable);
				}
			}).execute();
		}
	}
