...
public class JsonUtil {
	private static final LogTag LOG_TAG = LogUtils.getLogTag(JsonUtil.class.getSimpleName(), true);
	...
	public static String toJson(Object target, Type targetType, 
		...
		try {
			...
			LogUtils.e(LOG_TAG, "toJson", "目标对象 " + target.getClass().getName()
	...
	public static <T> T fromJson(String json, TypeToken<T> token,
		...
		try {
			...
			LogUtils.e(LOG_TAG, "fromJson", json + " 无法转换为 "
					+ token.getRawType().getName() + " 对象!" + ex);
			return null;
		}
	}
	...
	public static <T> T fromJson(String json, Class<T> clazz, String datePattern) {
		...
		try {
			...
			LogUtils.e(LOG_TAG, "fromJson", json + " 无法转换为 " + clazz.getName()
					+ " 对象!" + ex);
			return null;
		}
	}
