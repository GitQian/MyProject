...
import com.chinacnit.elevatorguard.mobile.ui.wheel.AbstractWheel;
import com.chinacnit.elevatorguard.mobile.ui.wheel.AbstractWheelTextAdapter;
import com.chinacnit.elevatorguard.mobile.ui.wheel.ArrayWheelAdapter;
import com.chinacnit.elevatorguard.mobile.ui.wheel.OnWheelScrollListener;
import com.chinacnit.elevatorguard.mobile.ui.wheel.WheelVerticalView;
...
public class CustomDatePicker extends LinearLayout {
	...
	public CustomDatePicker(final Context context, AttributeSet attrs) {
		...
		ArrayWheelAdapter adapter1 = new ArrayWheelAdapter(context, yearlist.toArray());
		ArrayWheelAdapter adapter2 = new ArrayWheelAdapter(context, monthlist.toArray());
	...
	/**
	 * 璁剧疆闄愬埗鏃ユ湡锛岃缃悗锛屼笉鑳介�鎷╄缃殑寮�鏃ユ湡浠ュ墠鐨勬棩鏈�
	 * 
	 * @param c
	 */
